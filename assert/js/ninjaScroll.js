$(document).ready(function () {
    ...
    if (!(Modernizr.touch) && (ninjaScroll.winW > ninjaScroll.minWidth)) 
    { // If device is not a touch-device, and if the width of the window is big enough
