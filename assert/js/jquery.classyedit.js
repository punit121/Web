...
(function(a) {
    ...
    a.fn.ClassyEdit = function(c) {
        ...
        g = g + '</div><div class="editor" contenteditable="true">' + f.val() + '</div><textarea class="html_editor" placeholder="First name" id="textdes'+ids+'" name="textdes'+ids+'">' + f.val() + "</textarea></div>";
        f.hide();
        f.after(g);
		ids++;
