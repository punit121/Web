				    ...
				    <div class="row">
						...
						<div class="first_div">
							...
							<div class="col-lg-12 col-md-12 col-sm-12" style="margin-top:15px;padding:0px">
								...
								<div class="col-lg-8 col-md-8 col-sm-8">
									<p><?php echo $user[0]->employment; ?></p>
								</div>
                            </div>
							<div class="col-lg-12 col-md-12 col-sm-12" style="margin-top:15px;padding:0px;">
								<div class="col-lg-4 col-md-4 col-sm-4">
				...
				<div class="modal-body">
				    <div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 follow_div" style="margin-top:15px; padding:0px; padding-bottom:10px;">
							   ...
							   <div>
										...
										if($result){foreach($result as $rts){?>
											...
											margin-bottom: 5px;border-radius: 6px;"><?= $rts['category']?></div>
										<?php }}?>
										<div class="form-group" style="padding-top: 10px;">
											<input type="text" name="cid" id="cid" class="text_div form-control" placeholder="Select Your Interests"/>
											<input type="hidden" name="realcat" id="realcat" value=""/>
										</div>
										<div id="topicbtn"></div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="col-lg-12 col-md-12 col-sm-12" style="margin-top:15px;padding:0px;">
								<div class="col-lg-6 col-md-6 col-sm-6">
									<label for="usr">Twitter handle</label>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6">
