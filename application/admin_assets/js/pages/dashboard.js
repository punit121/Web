$(document).ready(function() {
	...
	$(function () {
		...
		var dataCalendar=new Array();
		  var test='';
		  $.post(baseurl+'admin/findAppointmentForCalendar',function(reponse){
			console.log(reponse);
		  // if(response!='fail')
			// {
			   var data=eval(reponse);
			   $.each(data,function(index,value){
			    var temp = value.bookDate+' '+value.bookTime;
				var startDate = new Date(temp);
				var temp1 = value.bookDate+' '+value.endTime;
				var endDate = new Date(temp1);
				test={title:'Customer '+value.customerName+' Appointment with employee '+value.empName+' At '+value.bookTime+'',start: startDate,end: endDate, allDay: false,color: '#25a7e8',borderColor: '#0d7fb8'};
				dataCalendar.push(test);
			   });
			//}  
		//calendar example
