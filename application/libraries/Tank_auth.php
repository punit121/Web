...

{
					...
					if ($user->banned == 1) {									// fail - banned
						...
						if ($user->activated == 0) {							// fail - not activated
							...
							$this->error = array('not_activated' => '');
					            ...
					            echo "alert('Incorrect Email or Password. Please ensure email is verified thorugh OTP verification');\n";
	...
	function create_user($username, $email,$number = "", $password,$firstname,$lastname, $fbgmId,$business,$userlevel,$email_activation)
...
if($userlevel==4){
	...
	function change_Activation_email($email)

	{

		$user_id = $this->ci->users->get_user_id_by_email($email);
	...
	function checkPassword($old_pass)
	...
	function checkPwd($old_pass,$dbpwd)

	{	

	$i=0; 

	  foreach($dbpwd as $val)

		{

		$hasher = new PasswordHash(8,'TRUE');

		if ($hasher->CheckPassword($old_pass,$val['password'])) {
	...
	function change_password1($old_pass, $new_pass)
