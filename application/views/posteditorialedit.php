		...
		<div class="main_div" style="border: solid 1px black;margin-top: 31px;">
			<div style="width: 100%;margin: 0 auto;">
				 ...
				 <div style="border:solid 1px gray;">
					<div class="txtarea" style="display:inline-block; border:none;width:95%;">	
						<section class="clearfix">
							<div>
							<textarea class="classy-editor" name="intro" id="intro">agrae</textarea>
				...
				<div style="border-top:1px solid #555">
					<img src="<?= base_url();?>assert\images\slide-2.jpg" style="width:100%;height:300px;">		
				</div>
			</div>
			<div class="txt_append">
			    <div style="border:solid 1px gray;">
					<div class="txtarea" style="display:inline-block; border:none;width:95%;">		
						<section class="clearfix">
							<div>
								<textarea class="classy-editor1" name="introd" id="introd">sona</textarea>
							</div>
			...
			<div style="margin-top: 10px;">
				...
				<div style="text-align:center">
					...
					<div style="text-align:right" id='submitdiv'>
						<div class="btn-group">
							<button type="submit" name="publish" id="publish" class="btn btn-danger">Update</button>
					    </div>
					</div>
