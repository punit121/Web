...
<div class="main-content-top">
		...
		<h2 class="headerTxt">Book Beauty Appointments in San Francisco, CA</h2>
		...
		<article class="post col1-alternative">
				<div class="row">
					...
					<div class="large-1 medium-1 small-1 columns">
						<ul class="meta">
							<!--<li><a href="#" class="small button" style="width:56px"><span class=" icon-star left"></span><div class="left" style="font-size:12px;"></div></a></li>
		...
		<article class="post col1-alternative">
				<div class="row">
					...
					<div class="large-5 medium-5 small-5 columns">					
						...
						<p class="post_text"><?=$value['description']?></p>
						<p class="post_text"><?=$value['location']?></p>
						<a href="<?=base_url();?>viewmap/<?=$value['merchantId']?>" style="padding-right:22px;">View Map</a>
						<!--<a href="#">View Menu</a>-->						
					</div>
					<?php $result=$this->usermodel->findRating($value['merchantId']);?>
					<div class="large-1 medium-1 small-1 columns">
