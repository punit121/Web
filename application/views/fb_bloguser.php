    ...
    <div class="row">
    	<div class="main-feed">
         ...
         <div class="large-2 columns">
            <a href="<?= base_url();?>Zersey&Me" class="btn" style="text-decoration:none"><i class="glyphicon glyphicon-arrow-left"></i> Back To Zersey&amp;Me</a>
		...
		$a=$this->blogmodel->get_data($id);
            ...
            ?></time>
                 ...
                 <div class="post-status clearfix">
                     <div class="post-detail-content col-lg-12" >
       ...
       <p  id="p<?=  $pts['id'];?>"><?php echo $pts['intro']; ?></p>
       <center>
       <img src="<?php echo base_url();?>assets/zerseynme/<?php echo $pts['image']; ?>" style="width:70%;" />
       </center>
...
{ 
	...
	{ 
	 ...
	 ?>
				<div class="col-lg-12">	<div class="col-lg-6"><p  id="p<?=  $pt['id'];?>"><?php if(strlen($pt['description'])>400){echo substr($pt['description'],0,400)."...<a href='#' ref='p".$pt['id']."' class='readmr'>Read More.</a>";}else{echo $pt['description'];} ?></p><p id="pp<?= $pt['id'];?>" style="display:none;"><?php echo $pt['description'];?></p>	

  </div><div class="col-lg-6">



<img src="<?php echo base_url();?>assets/zerseynme/<?php echo $pt['photo']; ?>" style="width:100%;" /></br>
</div></div>
<?php }
else
{ if($j!=0)
     {
	   ...
	   <div class="col-lg-12">
<div class="col-lg-6">
<img src="<?php echo base_url();?>assets/zerseynme/<?php echo $pt['photo']; ?>" style="width:100%" />
</div><div class="col-lg-6">
<p  id="p<?= $pt['id'];?>"><?php if(strlen($pt['description'])>400){echo substr($pt['description'],0,400)."...<a href='#' ref='p".$pt['id']."' class='readmr'>Read More.</a>";}else{echo $pt['description'];} ?></p><p id="pp<?= $pt['id'];?>" style="display:none;"><?php echo $pt['description'];?></p>	</br>
</div></div>
