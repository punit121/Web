		    ...
		    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					  ...
					  <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
							...
							else { echo base_url().'assets/images/merchant/usericon.jpg'; }?>" class="logo_img">
							</div>
...
<div class="main" style="width:100%;">	
	...
	<a href="#" style="display:inline-block;" data-toggle="modal" data-target="#updatestatusmodla">
						...
						<li>
							...
							<div class="addpost">
							<?php if(!empty($catname)){?>
                                <a href="<?= base_url();?>postvertualstory/<?= $catname ?>" style="display:inline-block;" >
...
<div id="newpopup" class="modal fade" role="dialog">
        <div class="modal-dialog" >
            <!-- Modal content-->
                ...
                <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"> Select Category of your story </h4>
      </div>
      <div class="modal-body">
               <div>            
           <?php $cat=$this->datamodel->catlist();
		   foreach($cat as $ct){
		  
		   ?>
            <div class="catpopdiv">
            <a href="<?= base_url();?>postvertualstory/<?= $ct['category'] ?>">
...
<div id="popupeditorl" class="modal fade" role="dialog">
        <div class="modal-dialog" >
            <!-- Modal content-->
                ...
                <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"> Select Category for your Editorial </h4>
      </div>
      <div class="modal-body">
               <div>            
           <?php $cat=$this->datamodel->catlist();
        ...
        <div class="modal-dialog" >
            <!-- Modal content-->
             <div class="modal-content">
				...
				<div class="modal-body">
					   <div>            
						   <?php $bat=$this->datamodel->bordlist();
						   foreach($bat as $bt){
						  
						   ?>
							<div class="catpopdiv">
							<a href="<?= base_url();?>poststoryboard/<?= $bt['bordname']?>">
							<div style="width:100%;" class="catpopuptext">
							 <img src="<?php echo base_url().'assert/images/Board_Profile_Pic_Icon.png';?>" class="follow" style="width:100%;"></div>
