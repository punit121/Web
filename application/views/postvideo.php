...
{	
	...
	{
		//alert("Yes for pic");
		text='Please insert a video Url';
...
<?php if(empty($boards)){?>
    ...
    <form action="<?= base_url();?>users/insertvideo" method="post" id="edform" enctype="multipart/form-data" onSubmit="return validate()">
	...
	<div class="container main_container" style="width:600px">
     <a href="<?= base_url();?>"><i class="fa fa-times fa-2x popup_cross_icon"></i></a>
        ...
        <?php if(count($cat)){ ?>
			...
			<div id="video_url_div">
			<input type="text" class="form-control" name="url" id="url" placeholder="Paste Youtube or vine video Url">
			</div>
			<div id="pic1">  &nbsp; </div>
