    	...
    	//alert("hello");
  			...
  			//alert(last_post_id);
               $("#dashboard_image_div").append('<img src="<?= base_url()?>assert/images/loading_spinner.gif"  id="loading">');
                ...
                url:  "<?= base_url()?>users/categorytopicloop/<?php echo $this->uri->segment(2); ?>/<?php echo $this->uri->segment(3); ?>",
						...
						$cat= $this->datamodel->fetchcatid($catnm);
							$res=$cat[0]['category'];
                                ...
                                $pro=$this->datamodel->selectfollow($res,$uid);
													$folid=$pro[0]['fcid'];
                            ?>
								<a href="<?=base_url()?>category/<?=$catnm?>"><h3 class="middle_user_name"><?= ucfirst($catnm)?></h3></a>

								<p class="discription_div">  <?= $num_post?> posts</p>
							</div>
						</div>
...
?>
                        ...
                        <?php }?>
							<div class="imgholder">
                                ...
                                <img src="http://m.zersey.com/assets/zerseynme/<?= $pt['image']?>" width="200px" height="200px" />
                              
                                <?php } else {?>
                                   <img src="http://zersey.com/assets/zerseynme/<?= $pt['image']?>" width="200px" height="200px" />
                                 <?php }?>
				   ...
				   <div class="col-lg-12 col-md-12 col-sm-12" style="padding:5px;margin-top:-8%;" id="dashboard_image_div">
					<?php if(isset($post1))
					{
						?>
